...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery: Schema.Attribute.Decimal & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    badge: Schema.Attribute.Enumeration<['discount', 'hot', 'new']>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    stock: Schema.Attribute.Enumeration<['in stock', 'out of stock']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSavedAddressSavedAddress
  extends Struct.CollectionTypeSchema {
  collectionName: 'saved_addresses';
  info: {
    displayName: 'saved address';
    pluralName: 'saved-addresses';
    singularName: 'saved-address';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    label: Schema.Attribute.Enumeration<['Home', 'Office', 'Other']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-address.saved-address'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::saved-address.saved-address': ApiSavedAddressSavedAddress;
